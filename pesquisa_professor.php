...
<body>
	...
	<!--Navbar-->
		...
		if(isset( $_POST['submit-search'])){
		  		...
		  		$query_pesquisa = "select distinct(Nome_Professor), Email, estados_professores.Estado, Nome_Disciplina
								...
								and Nome_Professor LIKE '%$pesquisa%'; ";
				...
				if ($resultCheck_pesquisa > 0){
				 ?>
					...
					<button type="submit" name="submit-search" class="btn btn-dark" style=margin:10px;>
        		            <a style="text-decoration:none; color:white" href="docentes.php">Voltar</a>
    		        </button>
