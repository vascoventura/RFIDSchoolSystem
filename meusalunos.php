		  ...
		  <div class="search-container1">
		    <form action="pesquisa_aluno.php" method="POST">
		  	...
		  	<?php 
		  		...
		  		$sql_dropdown = "select 
								distinct(disciplinas.Nome_Disciplina)
								from
								disciplinas, aulas, users, professores
								where disciplinas.Id_Disciplina = aulas.DisciplinaId
			...
			?>
				...
				<?php
					if ($selected_val){ 
						$sql = "select distinct(inscricoes.AlunoId),
								 alunos.Nome_Aluno, 
								 alunos.Email,
			...
			?> 		<div class="table-responsive">          
				    ...
				    <button type="submit" name="submit-search" class="btn btn-dark" style="margin-top: 10px">
